...
export default function From() {
    return (
        <div className='bg-white px-10 py-20 rounded-3xl border-2 border-gray-100'>
            ...
            <div className='mt-8'>
                <div>
                    <label className='text-lg font-medium'>Usename or Email</label>
                    <input
                        className='w-full bordedr-2 border-gray-100 rounded-xl p-4 mt-1 bg-transparent'
                        placeholder='Enter your Usename or Enter your email'
                    />
                </div>
                <div>
